...
export default () => (
  <section className="person section-content">
    ...
    <p>
      ...
      mentoring junior developers and helping to onboard new starters, I pride
      myself on my communication skills. Working with others is part of software
      development that I genuinely enjoy. I advocate strongly for teams to be as
